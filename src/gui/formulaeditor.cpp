...
FormulaEditor::FormulaEditor(QWidget *parent) :
    QDialog(parent),
...
void FormulaEditor::on_pushButton_clicked()
{
    close();
}
...
int FormulaEditor::getFormulaResolution() const
{
    return formulaResolution;
}

const QString &FormulaEditor::getLatex() const
{
    return latexString;
}
