...
const QString &FormulaTool::getLatexString() const { return latexString; }

void FormulaTool::setLatexString(const QString &newLatexString) { latexString = newLatexString; }

int FormulaTool::getLatexRes() const { return latexRes; }

void FormulaTool::setLatexRes(int newLatexRes) { latexRes = newLatexRes; }

int FormulaTool::type() const { return Type; }
