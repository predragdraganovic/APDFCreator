...
void ImageTool::setImage(){
    QString fileName = QFileDialog::getOpenFileName(nullptr, "Add an image","","Image files (*.jpg *.jpeg *.png *.bmp)");
...
qreal ImageTool::getImage_scale() const
{
    return image_scale;
}

void ImageTool::setImage_scale(qreal newImage_scale)
{
    image_scale = newImage_scale;
}

int ImageTool::getOriginalWidth() const
{
    return originalWidth;
}

void ImageTool::setOriginalWidth(int newOriginalWidth)
{
    originalWidth = newOriginalWidth;
}

int ImageTool::getOriginalHeight() const
{
    return originalHeight;
}

void ImageTool::setOriginalHeight(int newOriginalHeight)
{
    originalHeight = newOriginalHeight;
}

const QPixmap &ImageTool::getOriginalPixmap() const
{
    return originalPixmap;
}

void ImageTool::setOriginalPixmap(const QPixmap &newOriginalPixmap)
{
    originalPixmap = newOriginalPixmap;
}
