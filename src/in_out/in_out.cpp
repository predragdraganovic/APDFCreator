...
void InputOutput::saveToApdf(Document &document)
{
    ...
    {
        QString fileName =
            QFileDialog::getSaveFileName(nullptr, "Save as...", QString(), QObject::tr("APDF format (*.apdf)"));
...
QFile *InputOutput::getCurrentFile() const { return currentFile; }

void InputOutput::setCurrentFile(QFile *newCurrentFile) { currentFile = newCurrentFile; }
