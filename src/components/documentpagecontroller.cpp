...
{
    // emits in both ifs because we can be at page 3 and then jump to 0, field
    // will become 1 but the page wont change
...
void DocumentPageController::currentPageSubmit() { emit setCurrentPage(inputCurrentPage->text().toInt()); }
